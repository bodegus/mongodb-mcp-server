...
export type CreateSessionStoreFn<TTransport extends CloseableTransport = CloseableTransport, TMetrics extends MetricDefinitions = MetricDefinitions> = (args: SessionStoreConstructorArgs<TMetrics>) => ISessionStore<TTransport>;
