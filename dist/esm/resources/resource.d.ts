...
export declare abstract class ReactiveResource<Value, RelevantEvents extends readonly (keyof SessionEvents)[], TUserConfig extends UserConfig = UserConfig, TContext = unknown> {
    ...
    register(server: Server<TUserConfig, TContext>): void;
