...
export class StreamsBuildTool extends StreamsToolBase {
    constructor() {
        ...
        this.argsShape = {
            ...
            connectionConfig: ConnectionConfig.optional().describe("Type-specific connection configuration. Only for resource='connection'. " +
            ...
            // PrivateLink fields
            privateLinkConfig: PrivateLinkConfig.optional().describe("PrivateLink configuration including provider and provider-specific fields. Required when resource='privatelink'."),
        };
    }
    async execute(args) {
