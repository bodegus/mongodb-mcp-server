...
const CreateIndexOutputSchema = {
    ...
    indexType: zod_1.z.enum(["classic", "vectorSearch", "search"]),
};
        ...
        this.argsShape = {
            ...
            definition: zod_1.z
                ...
                zod_1.z
                    ...
                    keys: zod_1.z
                        .record(zod_1.z.string(), mongodbSchemas_js_1.IndexDirectionSchema.describe("The index key and its direction"))
                ...
                .describe("The index definition. Use 'classic' for standard indexes, 'vectorSearch' for vector search indexes, and 'search' for Atlas Search (lexical) indexes."),
        };
        this.outputSchema = CreateIndexOutputSchema;
    }
