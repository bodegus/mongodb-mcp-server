...
class StreamsToolBase extends atlasTool_js_1.AtlasToolBase {
    handleError(error, args) {
        if (error instanceof apiClientError_js_1.ApiClientError) {
            ...
            if (statusCode === 400) {
                ...
                let hint = "This usually indicates invalid configuration or pipeline syntax. Check the request parameters and try again.";
        ...
        if (error instanceof Error && error.message.includes("resumeFromCheckpoint")) {
            return {
                content: [
                    {
                        type: "text",
                        text: `Checkpoint conflict: ${error.message}\n\n` +
        ...
        if (error instanceof Error &&
            ...
            return {
                content: [
                    {
                        type: "text",
                        text: `Authentication failure: ${error.message}\n\n` +
    ...
    static extractConnectionNames(obj) {
        const names = new Set();
...
exports.StreamsToolBase = StreamsToolBase;
//# sourceMappingURL=streamsToolBase.js.map