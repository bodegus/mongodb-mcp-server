...
exports.StreamableHttpRunner = exports.JSON_RPC_ERROR_CODE_DISALLOWED_EXTERNAL_SESSION = exports.JSON_RPC_ERROR_CODE_INVALID_REQUEST = exports.JSON_RPC_ERROR_CODE_SESSION_NOT_FOUND = exports.JSON_RPC_ERROR_CODE_SESSION_ID_INVALID = exports.JSON_RPC_ERROR_CODE_SESSION_ID_REQUIRED = exports.JSON_RPC_ERROR_CODE_PROCESSING_REQUEST_FAILED = exports.MonitoringServer = exports.createDefaultMonitoringServer = void 0;
...
class StreamableHttpRunner extends base_js_1.TransportRunnerBase {
    ...
    async start({ serverOptions, sessionOptions, } = {}) {
        this.validateConfig();
        this.mcpServer = new mcpHttpServer_js_1.MCPHttpServer({
