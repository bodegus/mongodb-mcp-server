 ...
 */
function getConnectionStringInfo(connectionString, config, atlasInfo) {
    return {
 ...
 */
function getHostType(connectionString) {
    if ((0, mongodb_build_info_1.isAtlas)(connectionString)) {
        return "atlas";
    }
    return "unknown";
}
 ...
 */
function getAuthType(config, connectionString) {
    const connString = new mongodb_connection_string_url_1.ConnectionString(connectionString);
