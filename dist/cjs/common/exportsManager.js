...
exports.decodeAndNormalize = decodeAndNormalize;
...
class ExportsManager extends events_1.default {
    ...
    async readExport(exportName) {
        try {
            ...
            return {
                content: await promises_1.default.readFile(exportPath, { encoding: "utf8", signal: this.shutdownController.signal }),
                docsTransformed,
            };
        }
        catch (error) {
    ...
    async startExport({ input, jsonExportFormat, inProgressExport, }) {
        try {
            ...
            try {
                ...
                await (0, promises_2.pipeline)([input.stream(), ejsonTransform, outputStream], {
    ...
    docToEJSONStream(ejsonOptions) {
        let docsTransformed = 0;
        const result = Object.assign(new stream_1.Transform({
            objectMode: true,
...
function decodeAndNormalize(text) {
